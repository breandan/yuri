...
sealed class G(val uri: String = "/") {
    ...
    object projectDir : G("/home/brendan/IdeaProjects/yuri") {
        @JvmName("_dot_")
        ...
        @JvmName("out")
        operator fun div(@Suppress(unused) a: out.Companion) = out<projectDir>(uri)

        @JvmName("settings_dot_gradle")
        operator fun div(@Suppress(unused) a: settings_dot_gradle.Companion) = settings_dot_gradle<projectDir>(uri)
...
@JvmName("0")
operator fun <S : `out`<projectDir>> S.div(@Suppress(unused) a: production.Companion) = production<S>("$this")

@JvmName("1")
operator fun <S : production<`out`<projectDir>>> S.div(@Suppress(unused) a: classes.Companion) = classes<S>("$this")
...
@JvmName("5")
operator fun <S : build<projectDir>> S.div(@Suppress(unused) a: resources.Companion) = resources<S>("$this")

@JvmName("6")
operator fun <S : resources<build<projectDir>>> S.div(@Suppress(unused) a: main.Companion) = main<S>("$this")
...
@JvmName("13")
operator fun <S : pluginDescriptors<build<projectDir>>> S.div(@Suppress(unused) a: co_dot_ndan_dot_yuri_dot_properties.Companion) = co_dot_ndan_dot_yuri_dot_properties<S>("$this")
...
@JvmName("18")
operator fun <S : _dot_gradle<projectDir>> S.div(@Suppress(unused) a: vcsWorkingDirs.Companion) = vcsWorkingDirs<S>("$this")

@JvmName("19")
operator fun <S : vcsWorkingDirs<_dot_gradle<projectDir>>> S.div(@Suppress(unused) a: gc_dot_properties.Companion) = gc_dot_properties<S>("$this")

@JvmName("20")
operator fun <S : src<projectDir>> S.div(@Suppress(unused) a: main.Companion) = main<S>("$this")

@JvmName("21")
operator fun <S : main<src<projectDir>>> S.div(@Suppress(unused) a: java.Companion) = java<S>("$this")
...
@JvmName("26")
operator fun <S : _dot_idea<projectDir>> S.div(@Suppress(unused) a: markdown_dash_exported_dash_files_dot_xml.Companion) = markdown_dash_exported_dash_files_dot_xml<S>("$this")
...
@JvmName("33")
operator fun <S : modules<_dot_idea<projectDir>>> S.div(@Suppress(unused) a: yuri_test_dot_iml.Companion) = yuri_test_dot_iml<S>("$this")

@JvmName("34")
operator fun <S : modules<_dot_idea<projectDir>>> S.div(@Suppress(unused) a: yuri_main_dot_iml.Companion) = yuri_main_dot_iml<S>("$this")
