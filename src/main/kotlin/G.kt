...
open class G(val uri: String = "/") {
    ...
    object project : G("/home/brendan/IdeaProjects/yuri") {
        @JvmName("_dot_")
        operator fun div(@Suppress(unused) a: _dot_.Companion) = _dot_<project>(uri)

        @JvmName("yuri_dot_iml")
        operator fun div(@Suppress(unused) a: yuri_dot_iml.Companion) = yuri_dot_iml<project>(uri)

        @JvmName("out")
        operator fun div(@Suppress(unused) a: out.Companion) = out<project>(uri)

        @JvmName("settings_dot_gradle")
        operator fun div(@Suppress(unused) a: settings_dot_gradle.Companion) = settings_dot_gradle<project>(uri)

        @JvmName("build")
        operator fun div(@Suppress(unused) a: build.Companion) = build<project>(uri)

        @JvmName("build_dot_gradle_dot_kts")
        operator fun div(@Suppress(unused) a: build_dot_gradle_dot_kts.Companion) = build_dot_gradle_dot_kts<project>(uri)

        @JvmName("_dot_gradle")
        operator fun div(@Suppress(unused) a: _dot_gradle.Companion) = _dot_gradle<project>(uri)

        @JvmName("README_dot_md")
        operator fun div(@Suppress(unused) a: README_dot_md.Companion) = README_dot_md<project>(uri)

        @JvmName("gradlew_dot_bat")
        operator fun div(@Suppress(unused) a: gradlew_dot_bat.Companion) = gradlew_dot_bat<project>(uri)

        @JvmName("src")
        operator fun div(@Suppress(unused) a: src.Companion) = src<project>(uri)

        @JvmName("_dot_idea")
        operator fun div(@Suppress(unused) a: _dot_idea.Companion) = _dot_idea<project>(uri)

        @JvmName("gradlew")
        operator fun div(@Suppress(unused) a: gradlew.Companion) = gradlew<project>(uri)

        @JvmName("gradle")
        operator fun div(@Suppress(unused) a: gradle.Companion) = gradle<project>(uri)
